            ...
            <ul class="nav nav-stacked nav-pills">
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="fa @if (!$item->featured) fa-unlock @else fa-lock @endif  text-light-blue"></i>
                        @if (!$item->featured) <span class="label label-primary">ON</span> @else <span class="label label-default">OFF</span> @endif
                    </a>
                </li>
